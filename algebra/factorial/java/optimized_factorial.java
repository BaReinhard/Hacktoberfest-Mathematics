...
public class OptimizedFactorial {
    ...
    public static void main(String[] args) {
        int yourNumber = 23; // change for any number above or equal 0;
        OptimizedFactorial optimizedFactorial = new OptimizedFactorial(yourNumber);
        BigInteger result = optimizedFactorial.getFactorial(yourNumber); // any number below 23 and above or equal 0
